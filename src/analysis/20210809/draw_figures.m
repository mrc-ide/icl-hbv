...
% Figures 1e--1f, 2a--2d, 3a, 3b, 4a--4b, 5a--5b and 
...
%filename = '/home/mdevilli/Dropbox/Birth_dose_publication_submission/Nature_Communications/202104/data_and_code/uploaded/to_delete/results_countries_default_stochastic_run_1.mat';
%filename = '/home/mdevilli/Dropbox/Birth_dose_publication_submission/Nature_Communications/202104/data_and_code/ready_to_upload_20210806/to_delete/results_countries_default_stochastic_run_1.mat';
...
%infilepath_stochastic_results = '\\fi--didenas1\vimc-hepb\BD_runs_202103_default\';
%infilepath_stochastic_results = '\\fi--didenas1\vimc-hepb\BD_runs_20210714_default\';
...
[countries_list, perc_global_total_excess_deaths_vec] = draw_Fig_3b_fun(...
    num_stochas_runs,...
...
Fig_4a_data_struc = prepare_Fig_4a_data_struc_fun(...
    ...
    ListOfScenarios,ListOfScenarioLabels,scenario_nums_struct,scenario_colour_mat,...
...
function [countries_list, perc_global_total_excess_deaths_vec] = draw_Fig_3b_fun(...
    num_stochas_runs,...
    cohort_years_vec,cohort_years_pos_vec,...
    scenario_nums_struct,...
    num_countries,countries_list,...
...
function fig_struct = prepare_Fig_4a_data_struc_fun(...
    ...
    for region_num=1:num_regions_global
        ...
        regions_year_of_elim_prev_status_quo_mat_lower_median_upper = ...
            find_year_of_elim_fun(countries_list,num_year_divisions,calandar_years_vec,calandar_years_pos_vec,i2020,i2030,...
...
function year_of_elim_prev_mat_lower_median_upper = ...
    find_year_of_elim_fun(countries_list,num_year_divisions,calandar_years_vec,calandar_years_pos_vec,begin_year_index,end_year_index,...
